...
#write.csv(permanova.gut.subsection,file="permanova.gut.subsection.csv") export permanova results and save as CSV to be used for Table X2 in manuscript.
...
pairwise.gut.subsection=pairwise.adonis(weighted.unifrac.F4.F8.dist,metadata.fish.F4.F8.unifrac$Gut_SubSection,p.adjust.m = "BH")
pairwise.gut.subsection

#write.csv(pairwise.gut.subsection,file="pairwise.gut.subsection.csv") export pairwsie adonis results as CSV and use for Table SX in manuscript. 
...
#ordiellipse(nmds.weighted.unifrac.F4.F8,metadata.fish.F4.F8.unifrac$Gut_Section,kind="sd",draw="polygon",alpha=c(0,0),lwd=2.5,border=colvec3) #add SD ellipses, colored by Gut_Section. For now I will not use this.

#Export as 8.5x11 PDF. merge with a legend and use that as Figure X3 for manuscript.
```
