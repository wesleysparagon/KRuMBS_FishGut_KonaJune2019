...
write.csv(relabund.cull.family.df,file="relabund.cull.family.df") #Export the ralbund.cull.genus (or family) data as a CSV and open it in JMP. Use JMP to create stacked bar charts.
```
