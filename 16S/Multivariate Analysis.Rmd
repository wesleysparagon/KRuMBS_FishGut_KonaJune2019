...
#Model F4-F8 distance matrix without PC samples, predictor variable: Gut_subsection. Use adonis2 marginal tests. 
permanova.gut.subsection.v1=adonis2(weighted.unifrac.F4.F8.dist~Gut_SubSection,by="margin",data=metadata.fish.F4.F8.unifrac,permutations=999)
permanova.gut.subsection.v1

#Model F4-F8 distance matrix without PC samples, predictor variable: Gut_section and fish ID. Use adonis2 marginal tests. 
permanova.gut.subsection.fishID=adonis2(weighted.unifrac.F4.F8.dist~Gut_SubSection + Fish_Number,by="margin",data=metadata.fish.F4.F8.unifrac,permutations=999)
...
permanova.gut.subsection.v2=adonis2(weighted.unifrac.F4.F5.F8.dist~Gut_SubSection,by="margin",data=metadata.fish.F4.F5.F8.unifrac,permutations=999)
permanova.gut.subsection.v2

#Repeat for gut section.
permanova.gut.section.v2=adonis2(weighted.unifrac.F4.F5.F8.dist~Gut_Section,by="margin",data=metadata.fish.F4.F5.F8.unifrac,permutations=999)
permanova.gut.section.v2
...
```{r}
#pointvec=c(15,16,17) #generate a vector of points to correspond to Species. No longer needed.
...
points(nmds.weighted.unifrac.F4.F8, #plot each sample as a point
       cex=3.5,
       pch=16, #pointvec[metadata.fish.F4.F8.unifrac$Species], #point shape corresponds to fish Species. No longer needed.
       col=colvec2[as.factor(metadata.fish.F4.F8.unifrac$Gut_SubSection)]) 
text(-.465,.4,label="Stress=.14",cex=1.5)
ordiellipse(nmds.weighted.unifrac.F4.F8,metadata.fish.F4.F8.unifrac$Gut_SubSection1,kind="sd",draw="polygon",lwd=2.5,border=colvec2[-6:-7],col=colvec2[-6:-7],alpha=50) #add SD ellipses, colored by Gut_Section. 
...
#repeat but without species
adiv.mod.gut.subsection.sobs.v1=lmer(sobs~Gut_SubSection+(1|Fish_Number),data=alpha.diversity.fish.F4.F8)
...
lsmeans(adiv.mod.gut.subsection.sobs.v1, pairwise ~ Gut_SubSection, adjust="tukey") #Post Hoc analysis for the Gut_SubSection factor. This function averages across Species so that it is ONLY testing the differences between Gut_SubSection. 

#Repeat for the F4.F5.F8 data.
adiv.mod.gut.subsection.sobs.v2=lmer(sobs~Gut_SubSection+(1|Fish_Number),data=alpha.diversity.fish.F4.F5.F8)
summary(adiv.mod.gut.subsection.sobs.v2)
anova(adiv.mod.gut.subsection.sobs.v2,ddf="Kenward-Roger") #Gut_SubSection is significant, Species is not significant.
...
adiv.mod.gut.subsection.shannoneven.v1=lmer(shannoneven~Gut_SubSection+(1|Fish_Number),data=alpha.diversity.fish.F4.F8)
...
lsmeans(adiv.mod.gut.subsection.shannoneven.v1, pairwise ~ Gut_SubSection, adjust="tukey")

#Repeat for the F4.F5.F8 data.
adiv.mod.gut.subsection.shannoneven.v2=lmer(shannoneven~Gut_SubSection+(1|Fish_Number),data=alpha.diversity.fish.F4.F5.F8)
summary(adiv.mod.gut.subsection.shannoneven.v2)
anova(adiv.mod.gut.subsection.shannoneven.v2,ddf="Kenward-Roger") #Gut_SubSection is significant, species is not.
...
#repeat without species
adiv.mod.gut.subsection.shannon.v1=lmer(shannon~Gut_SubSection+(1|Fish_Number),data=alpha.diversity.fish.F4.F8)
...
lsmeans(adiv.mod.gut.subsection.shannon.v1, pairwise ~ Gut_SubSection, adjust="tukey")

#Repeat for the F4.F5.F8 data.
adiv.mod.gut.subsection.shannon.v2=lmer(shannon~Gut_SubSection+(1|Fish_Number),data=alpha.diversity.fish.F4.F5.F8)
summary(adiv.mod.gut.subsection.shannon.v2)
anova(adiv.mod.gut.subsection.shannon.v2,ddf="Kenward-Roger") #Gut_SubSection is significant, species is not.
...
#Repeat without species
dispersion.mod.gut.subsection.v1=lmer(sqrt.distances~Gut_SubSection+(1|Fish_Number),data=dispersion.gut.subsection1)
...
lsmeans(dispersion.mod.gut.subsection.v1, pairwise ~ Gut_SubSection, adjust="tukey")

#Repeat for F4.F5.F8 data
dispersion.mod.gut.subsection.v2=lmer(sqrt.distances~Gut_SubSection+(1|Fish_Number),data=dispersion.gut.subsection.F4.F5.F8.1)
summary(dispersion.mod.gut.subsection.v2)
anova(dispersion.mod.gut.subsection.v2,ddf="Kenward-Roger") #Gut_SubSectionis significant.
```
