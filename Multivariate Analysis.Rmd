...
legend(.2,.42,legend = c(levels(as.factor(metadata.fish.1$Gut_Section))[1:4],levels(as.factor(metadata.fish.1$Species))[1:3]),cex=1,y.intersp=.2,bg="transparent",bty="o",col=c(colvec,"black","black","black"),pch=c(16,16,16,16,15,16,17),pt.cex=1.5) #Add legend. Save image as 8.5x11 PDF (landscape)
...
boxplot(dispersion.gut.section)
...
boxplot(dispersion.gut.subsection)
```
