...
```{r}
#Calculate means and SE of the sobs and shannon evenness alpha diversity metrics for each Gut_SubSection and save as a df. #I will not hash this out since I am using the geom_boxplot() function instead of the geom_bar() function, which means I don't need means and SE.
