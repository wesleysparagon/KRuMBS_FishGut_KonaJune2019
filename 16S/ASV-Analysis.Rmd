...
#repeat this graph except using geom_point and geom_line to better visualize individual ASV behavior (peaking at various subsections, etc). Export as 2000x1500 PNG to use in figure with two way heatmap.
