...
write.csv(as.matrix(permanova.gut.subsection),file="permanova.gut.subsection.csv") #export permanova results and save as CSV to be used for Table X2 in manuscript.
...
plot_grid(sobs.gut.subsection.plot,shannoneven.gut.subsection.plot) ##use the plot_grid function to plot the above 2 plots (par(mfrow=())) doesnt work with ggplot2. Save as PNG (1095 x 485) and use as Figure 1 in manuscript.
```
...
#save as 8.5x11 and use as Figure 2
