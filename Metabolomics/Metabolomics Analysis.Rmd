...
permanova.gut.subsection.v1=adonis2(bray.relabund.19.jun.clean2.2.v1~Gut_SubSection,by="margin",data=metadata.19.jun.samples2.v1,permutations=999)
...
#Repeat for F4.F5.F8 data
dispersion.mb.mod.gut.subsection.v1=lmer(`bray curtis distance to centroid`~Gut_SubSection+(1|Fish_Number),data=dispersion.mb.gut.subsection1.v1)
