...
dispersion.mb.gut.subsection.plot.v1=ggplot(dispersion.mb.gut.subsection1,aes(y=`bray curtis distance to centroid`,x=Gut_SubSection,fill=Gut_SubSection))+
  geom_boxplot()+
...
#went from 1133 ASVs to 549 ASVs
...
mixed.mod.relabund.19.jun.clean2.dist.t.4.cull.trans=apply(relabund.19.jun.clean2.dist.t.4.cull.trans[,-549:-568],2,FUN=mixed.mod) #apply mixed.mod only to columns containing ASV data. Save as new object.
