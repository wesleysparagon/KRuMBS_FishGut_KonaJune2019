...
#Model F4-F8 distance matrix without PC samples, predictor variable: Gut_section. Use adonis2 marginal tests. 
permanova.gut.section.v1=adonis2(weighted.unifrac.F4.F8.dist~Gut_Section,by="margin",data=metadata.fish.F4.F8.unifrac,permutations=999)
