...
metadata$Gut_SubSection=factor(metadata$Gut_SubSection,levels=c("ST","GI","GI_1","GI_2","GI_3","GI_4","HG","HG_1","HG_2","HG_3","No_Inoc","","PC")) #reorder the levels of the Gut_SubSection factor. This will be useful later when generating ordinations.
...
metadata.fish.2$Gut_Section=factor(metadata.fish.2$Gut_Zone,levels=c("ST","GI","HG","No_Inoc","","PC")) #reorder the levels of the Gut_section factor. This will be useful later when generating ordinations.
...
ordiellipse(nmds.weighted.unifrac.F4.F8.2,metadata.fish.F4.F8.2.unifrac$Gut_Section,kind="sd",draw="polygon",alpha=c(0,0),lwd=2.5,border=colvec3) #add SD ellipses, colored by Gut_Section
```
...
dispersion.gut.section3=as.data.frame(aggregate(dispersion.gut.section2$distances,by=list(dispersion.gut.section2$Gut_Section),FUN=mean))
dispersion.gut.section3$se=aggregate(dispersion.gut.section2$distances,by=list(dispersion.gut.section2$Gut_Section),FUN=stderror)[[2]]
