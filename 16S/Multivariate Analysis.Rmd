...
```{r}
#Model F4-F8 distance matrix without PC samples, variables of interest: Species and Gut_subsection. Use adonis2 marginal tests. 
...
#Using the same unifrac matrix, test the effect of gut SECTION and species.
permanova.gut.section=adonis2(weighted.unifrac.F4.F8.dist~Gut_Section+Species,by="margin",data=metadata.fish.F4.F8.unifrac,permutations=999)
